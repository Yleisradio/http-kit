(defproject yleisradio/http-kit "2.2.0-sni-support"
  :author "Feng Shen (@shenfeng) and Daniel Solano Gómez (for sni-fix)"
  :description "High-performance event-driven HTTP client/server for Clojure. This is temporary patch jar for SNI support. See https://github.com/http-kit/http-kit/pull/311."
